...
const partners = [
    { name: 'Clampco Sistemi', logo: '/images/partners/clampco.png', link: 'https://clampco.it/' },
    { name: 'NGI Technologies', logo: '/images/partners/ngi.webp', link: 'https://www.ngi-tech.com/' },
    { name: 'Sanwood', logo: '/images/partners/sanwood.png', link: 'https://www.sanwood.cc/' },
    { name: 'Ponovo', logo: '/images/partners/ponovo.png', link: 'https://www.ponovo.net/', darkBg: true }
];
